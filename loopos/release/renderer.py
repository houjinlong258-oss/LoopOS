...
def render_readiness(report: ReadinessReport) -> str:
    lines = [
        ...
        f"Package ready: {'true' if report.ready_to_package else 'false'}",
        f"Tag ready:     {'true' if report.ready_to_tag else 'false'}",
        f"Publish ready: {'true' if report.ready_to_publish else 'false'}",
